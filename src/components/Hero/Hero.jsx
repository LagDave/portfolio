      ...
      <div className="container">
        ...
        <div className="left">
          ...
          <p data-aos-delay="1000" data-aos="fade-right" className="description text-slate mt-4">
            I am a <span className="text-lightest-slate">passionate software engineer</span> who loves to build applications for the web.
        ...
        <div className="right">
          <Lottie data-aos-delay="1000" data-aos="fade-left" className="robo-lottie" animationData={roboLottie}/>
        </div>
