    ...
    <section id="about">
      ...
      <div className="container">
        ...
        <div data-aos="fade-left" className="right">
          ...
          <p>I got my first web dev job when I was 16 and from then on, things just got better and better for my career. Fast-forward to today, I've had the privilege to deliver solutions on various companies in different industries harnessing the web skills I garnered throughout the years. I have a substantial experience working at  <span className="text-green">a digital marketing agency,  a startup,</span> and   <span className="text-green">an outsourcing web development company</span>.</p>
