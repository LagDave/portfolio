    ...
    <section id="about">
      ...
      <div className="container">
        ...
        <div data-aos="fade-left" className="right">
          ...
          <p>Fast-forward to today, I've had the privilege to deliver solutions on various companies in different industries harnessing my web skills I garnered throughout the years. I have substantial experience working at  <span className="text-green">a digital marketing agency,  a startup, and  an outsourcing web development company</span>.</p>
          <p>Checkout my <a href="#">resume</a> to see the technologies I've worked with.</p>
        </div>
